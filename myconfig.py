...
# Options: 'ps3', 'ps4', 'xbox', 'nimbus', 'wiiu', 'F710', 'F710_pygame', 'rc3', 'MM1 (use for RC Hat)', 'custom'
# F710_pygame: Windows pygame mapping in parts/controller.py (Logicool F710 XInput)
...
DONKEY_GYM = True
# Use "remote" when starting donkey_sim.exe manually first.
# Or set a path such as r"..\DonkeySimWin\donkey_sim.exe"
